...
- [api.proto](#api.proto)
    - [HelloPoseidonMsg](#trident.HelloPoseidonMsg)
    - [PoseidonReply](#trident.PoseidonReply)
  
  
  
    - [PingPoseidon](#trident.PingPoseidon)
...
<a name="trident.HelloPoseidonMsg"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| name | [string](#string) |  | name of individual messaging poseidon |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| message | [string](#string) |  | reply from poseidon |
...
| ----------- | ------------ | ------------- | ------------|
| HelloPoseidon | [HelloPoseidonMsg](#trident.HelloPoseidonMsg) | [PoseidonReply](#trident.HelloPoseidonMsg) | Sends a greeting |
| HelloPoseidonAgain | [HelloPoseidonMsg](#trident.HelloPoseidonMsg) | [PoseidonReply](#trident.HelloPoseidonMsg) | Sends another greeting |
